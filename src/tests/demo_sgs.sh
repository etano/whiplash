...
$1 ./drivers/commit_executable.driver -dbhost $HOST -path apps/spin_glass_solver/bin/main -name sgs -class ising -description "desc" -algorithm "algo" -version "1.0" -build "O3" -owner akosenko
