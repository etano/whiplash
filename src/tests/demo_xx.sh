...
$1 ./drivers/commit_executable.driver -dbhost $HOST -path apps/XXcode/xx.shared -name xx -class xx -description "desc" -algorithm "algo" -version "1.0" -build "O3" -owner akosenko
