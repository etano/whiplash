...
$1 ./drivers/commit_model.driver -file apps/108problem.lat -class ising -owner akosenko -random "info"
echo 'Committing executable...'
$1 ./drivers/commit_executable.driver -file apps/anc/an_ms_r1_nf -class ising -description "desc" -algorithm "algo" -version "1.0" -build "O3" -owner ebrown
