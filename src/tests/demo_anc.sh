...
$1 ./drivers/commit_executable.driver -dbhost $HOST -path apps/anc/an_ss_rn_fi -name anc -class ising -description "desc" -algorithm "algo" -version "1.0" -build "O3" -owner ebrown
