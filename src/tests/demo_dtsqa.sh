...
$1 ./drivers/commit_executable.driver -dbhost $HOST -path apps/DT-SQA/dtsqa -name dtsqa -class ising -description "desc" -algorithm "algo" -version "1.0" -build "O3" -owner ebrown
