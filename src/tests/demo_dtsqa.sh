...
$1 ./drivers/commit_property.driver -dbhost $HOST -class ising -model 0 -executable 0 -owner akosenko -nsweeps 10000 -T_0 0.05  -T_1 0.05 -schedule "lin" -nslices 50 -gamma_0 2.5 -gamma_1 0
