...
$1 ./drivers/commit_executable.driver -file /Users/ethan/src/anc/an_ss_ge_fi_vdeg -class ising -description "desc" -algorithm "algo" -configuration "conf" -version "1.0" -build "O3" -owner akosenko
