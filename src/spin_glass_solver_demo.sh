...
$1 ./drivers/commit_executable.driver -file apps/spin_glass_solver/bin/main -class ising -description "desc" -algorithm "algo" -cfg "conf" -version "1.0" -build "O3" -owner akosenko
