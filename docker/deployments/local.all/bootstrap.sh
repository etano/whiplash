...
# Web-interface
docker run --link wdb-odb:mongo --name wdb-www -p 80:80 -v /var/www/html:/var/www/html -v /var/www/storage:/var/www/html/uploads -it -P -t whiplash/www:experimental
